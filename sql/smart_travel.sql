-- ============================================================
-- 智旅出行 · 智慧旅游出行系统 数据库初始化脚本
-- 表结构与景区/评价数据导出自真实项目库（图片链接保持原样）
-- 内置演示账号：admin / 123456（管理员），muyu / 123456（游客）
-- 适用：MySQL 8.0+，执行后自动建库 smart_travel
-- ============================================================

CREATE DATABASE IF NOT EXISTS smart_travel DEFAULT CHARACTER SET utf8mb4;
USE smart_travel;
...
-- ----------------------------
-- 景区与评价数据（导出自真实库，图片链接保持 picsum 原样）
-- ----------------------------
...
-- ----------------------------
-- 演示账号与示例订单（密码为 MD5(密码+盐)，均为 123456）
-- ----------------------------
INSERT INTO t_user (id, username, password, nickname, phone, role) VALUES
(1, 'admin', 'dc78ad13089ef5fcad49a2f7dc49cf18', '系统管理员', '13800000000', 'admin'),
(2, 'muyu',  'dc78ad13089ef5fcad49a2f7dc49cf18', '沐渔',       '13812345678', 'user');

INSERT INTO t_order (id, user_id, username, spot_name, order_date, ticket_count, status) VALUES
(1, 2, 'muyu', '荆楚古城',         '2026-09-09', 2, '已核销'),
(2, 2, 'muyu', '数字博物馆',       '2026-09-08', 3, '已核销'),
(3, 2, 'muyu', '智慧湿地',         '2026-09-09', 1, '已预约'),
(4, 2, 'muyu', '楚王车马阵驻地',   '2026-09-07', 2, '预约成功'),
(5, 2, 'muyu', '云梦泽生态风景区', '2026-09-06', 2, '待支付');
